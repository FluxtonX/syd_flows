    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Stats inside Avatar Card
          Row(
            children: [
              Expanded(child: _buildAvatarStat('26', 'WORKOUTS')),
              _buildAvatarDivider(),
              Expanded(child: _buildAvatarStat('248', 'MINUTES')),
              _buildAvatarDivider(),
              Expanded(child: _buildAvatarStat('12', 'STREAK')),
            ],
          ),
        ],
      ),
